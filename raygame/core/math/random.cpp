...
template std::vector<uint8_t>  core::math::rand_n(size_t amount, uint8_t min, uint8_t max);
template std::vector<uint16_t> core::math::rand_n(size_t amount, uint16_t min, uint16_t max);
template std::vector<uint32_t> core::math::rand_n(size_t amount, uint32_t min, uint32_t max);
template std::vector<uint64_t> core::math::rand_n(size_t amount, uint64_t min, uint64_t max);
template std::vector<int8_t>   core::math::rand_n(size_t amount, int8_t min, int8_t max);
template std::vector<int16_t>  core::math::rand_n(size_t amount, int16_t min, int16_t max);
template std::vector<int32_t>  core::math::rand_n(size_t amount, int32_t min, int32_t max);
template std::vector<int64_t>  core::math::rand_n(size_t amount, int64_t min, int64_t max);
