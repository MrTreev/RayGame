...
public:
     ...
     *
     * @throws raylib::RaylibException Throws if failed to create the
     * texture from the given image.
     */
     ...
     *
     * @throws raylib::RaylibException Throws if failed to create the
     * texture from the given cubemap.
     *
    ...
    void Load(const std::string& fileName) {
        ...
        if (!IsReady()) {
            throw RaylibException(
                "Failed to load Texture from file: " + fileName
            );
        }
    }
     ...
     * @see ::DrawTexture()
     */
    void Draw(int posX = 0, int posY = 0, ::Color tint = {255, 255, 255, 255})
        const {
