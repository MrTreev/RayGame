...
public:
    /**
     * Build a Window object, but defer the initialization. Ensure you call
     * Init() manually.
     *
     * @see Init()
     */
     ...
     * @param flags The ConfigFlags to set prior to initializing the window.
     * See SetConfigFlags for more details.
     *
     * @see ::SetConfigFlags()
     * @see ConfigFlags
     *
     * @throws raylib::RaylibException Thrown if the window failed to
     * initiate.
     */
    Window(
        int                width,
